...
public class Ask{
    ...
    public static Person askPerson(Console console, Integer id, String nameOrNull, boolean isRec)throws AskBreak{
        try {
            ...
            Person person = new Person(id, name, coordinates, location, height,weight,passportID, hairColor);
